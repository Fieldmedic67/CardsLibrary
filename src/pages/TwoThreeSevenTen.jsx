    ...
    return (
        <div>
            ...
            <div className="p1FaceUp"> {p1FaceUp.length > 0 && p1FaceUp.map((card, index) => (
                <img key={index} src={`https://deckofcardsapi.com/static/img/${card.code}.png`} onClick={() => Player1PlayFaceUp(index)} />))}
            </div>
            ...
            <div className="p1Hand"> {p1Hand.length > 0 && p1Hand.map((card, index) => (
                <img key={index} src={`https://deckofcardsapi.com/static/img/${card.code}.png`} onClick={() => Player1CardFromHand(index)} />))}
            </div>
            ...
            <div className="discardPile"> {discardPile.length > 0 && (
                <img src={`https://deckofcardsapi.com/static/img/${discardPile[discardPile.length - 1].code}.png`} />)}
            </div>
        </div>
    )
}
